...
export default function ContactPageClient({
  ...
  instagramUrl = "https://www.instagram.com/vikafilms.in",
  linkedinUrl = "https://www.linkedin.com/in/vivek-kamble-65a39b238",
}: ContactProps) {
  ...
  const contactItems = [
    ...
    { icon: "call",        label: "WHATSAPP", value: contactWhatsapp, href: contactWhatsappLink },
    { icon: "location_on", label: "STUDIO",   value: contactLocation, href: "#" },
  ];
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                      ...
                      >
                        <option value="" disabled style={{ backgroundColor: "#1f1f1f" }}>Select…</option>
                        <option value="commercial" style={{ backgroundColor: "#1f1f1f" }}>Commercial Campaign</option>
                        <option value="product" style={{ backgroundColor: "#1f1f1f" }}>3D Product Story</option>
                        <option value="editorial" style={{ backgroundColor: "#1f1f1f" }}>Editorial Narrative</option>
                        <option value="event" style={{ backgroundColor: "#1f1f1f" }}>Event Coverage</option>
